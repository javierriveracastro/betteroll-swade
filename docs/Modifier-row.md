Better Rolls 2 adds a section above the chat window allowing you to set up generic modifiers for your next roll (one click, white highlight) or all rolls until toggled off (double click, red highlight).
