...
export function activate_item_listeners(app, html) {
    ...
    const item_images = html.find('.item-image, .item-img, .item-show, span.item>.item-control.item-edit, .gear-card>.card-header>.item-name, .damage-roll, .item-name>h4, .power-header>.item-name');
