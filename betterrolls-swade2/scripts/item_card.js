...
async function create_item_card(origin, item_id, collapse_actions) {
    ...
    if ((item.data.data.actions.skill === "" && item.type === "gear") || item.data.data.actions.skill.toLowerCase() === "none" || (item.hasOwnProperty("data.data.actions") === false && item.type != "skill")) {
