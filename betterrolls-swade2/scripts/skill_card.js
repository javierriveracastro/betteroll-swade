...
export const FIGHTING_SKILLS = ["fighting", "kämpfen", "pelear", "combat","lutar"];
export const SHOOTING_SKILLS = ["shooting", "schiessen", "disparar", "tir","atirar"];
export const THROWING_SKILLS = ["athletics", "athletik", "atletismo", "athletisme",
    "athlétisme", "★ athletics","atletismo"];
