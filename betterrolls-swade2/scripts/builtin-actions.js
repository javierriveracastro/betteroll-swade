export const SYSTEM_GLOBAL_ACTION = [
    ...
    {id: "DimGm", name: "Dim", button_name: "BRSW.IlluminationDim", skillMod: "-2", selector_type: "gm_action", group: "BRSW.IlluminationGM"},
    {id: "DarkGm", name: "Dark", button_name: "BRSW.IlluminationDark", skillMod: "-4", selector_type: "gm_action", group: "BRSW.IlluminationGM"},
    {id: "PitchGm", name: "Pitch Dark", button_name: "BRSW.IlluminationPitch", skillMod: "-6", selector_type: "gm_action", group: "BRSW.IlluminationGM"},
    {id: "Dim", name: "Dim", button_name: "BRSW.IlluminationDim", selector_type: "all", skillMod: "-2", group: "BRSW.Illumination"},
    {id: "Dark", name: "Dark", button_name: "BRSW.IlluminationDark", selector_type: "all", skillMod: "-4", group: "BRSW.Illumination"},
    {id: "Pitch", name: "Pitch Dark", button_name: "BRSW.IlluminationPitch", selector_type: "all", skillMod: "-6", group: "BRSW.Illumination"},
