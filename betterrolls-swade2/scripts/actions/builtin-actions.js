...
export const SYSTEM_GLOBAL_ACTION = [
    ...
    },
    {
        ...
        selector_type: "actor_has_hindrance", selector_value: "BRSW.EdgeName-All-Thumbs",
    ...
    },
    {
        ...
        and_selector: [{selector_type: "actor_has_edge", selector_value: "BRSW.EdgeName-Attractive"}, {
            "or_selector": [
    ...
    },
    {
        ...
        skillMod: "+2",
        and_selector: [
            {selector_type: "actor_has_edge", selector_value: "BRSW.EdgeName-VeryAttractive"}, {
                or_selector: [
                    {selector_type: "skill", selector_value: "BRSW.SkillName-Performance"},
                    {selector_type: "skill", selector_value: "BRSW.SkillName-Persuasion"}]
            }],
    ...
    },
    {
        ...
        and_selector: [{selector_type: "actor_has_edge", selector_value: "BRSW.EdgeName-MartialArtist"},
    ...
    },
    {
        ...
        and_selector: [{selector_type: "actor_has_edge", selector_value: "BRSW.EdgeName-MartialWarrior"},
